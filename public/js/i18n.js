...
var I18N = {
  ...
  "her.v1d": { fr: "Un parcours familial depuis 1986 dans les drapeaux et les produits textiles officiels.", ar: "مسار عائلي ممتد منذ 1986 في صناعة الأعلام والمنتجات النسيجية الرسمية.", en: "A family journey since 1986 in official flags and textile products." },
  "her.v2":  { fr: "Qualité",           ar: "جودة",    en: "Quality" },
  "her.v2d": { fr: "Des matières sélectionnées, des couleurs stables et une finalisation adaptée aux usages officiels.", ar: "خامات مختارة، ألوان ثابتة، وإتمام يليق بالاستعمال الرسمي.", en: "Selected materials, stable colors and finalization suited for official use." },
